...
def report_pdf(data):
    ...
    story += [table, Spacer(1, 8*mm), Paragraph('Itens no prejuízo', styles['Heading2']),
    ...
    if negative:
        ...
        table.setStyle(TableStyle([('BACKGROUND',(0,0),(-1,0),colors.HexColor('#fcebe7')),('TEXTCOLOR',(-1,1),(-1,-1),colors.HexColor('#b74230')),
            ('FONTSIZE',(0,0),(-1,-1),9),('TOPPADDING',(0,0),(-1,-1),10),('BOTTOMPADDING',(0,0),(-1,-1),10),('ALIGN',(1,0),(-1,-1),'RIGHT')]))
        story.append(table)
    else:
